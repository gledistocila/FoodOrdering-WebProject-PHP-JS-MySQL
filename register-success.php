...
<title>Juvenilja:Regjistrimi i suksesshem</title>
...
<div id="center">
<h1>Regjistrimi i suksesshem</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<p>&nbsp;</p>
<p><a href="login-register.php">Klikoni ketu</a> per t'u loguar ne llogarine tuaj.</p>
</div>
</div>
<div id="footer">
