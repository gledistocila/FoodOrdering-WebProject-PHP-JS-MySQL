    ...
    if(isset($_POST['quantity']) && isset($_POST['item']))
        {
            ...
            or die("Sistemi po has probleme teknike. Ju lutemi provoni perseri pas disa minutash.");
            ...
            $result=mysql_query("SELECT * FROM food_details,cart_details WHERE cart_details.member_id='$member_id' AND cart_details.flag='$flag_0' AND cart_details.food_id=food_details.food_id AND cart_details.cart_id='$cart_id'") or die("Ndodhi nje problem ... \n" . "Skuadra jone po punon momentalisht ... \n" . "Ju lutem kontrolloni perseri pas disa oresh."); 
            ...
            die("Dicka shkoi gabim!Skuadra jone teknike po punon ne zgjidhjen e problemit.Ju lutemi provoni perseri pas disa minutash.");
        }
?>