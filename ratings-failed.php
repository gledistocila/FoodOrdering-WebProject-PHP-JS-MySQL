...
<title>Juvenilja:Vleresimi deshtoi</title>
...
<div id="center">
<h1>Vleresimi deshtoi</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<p>&nbsp;</p>
<div class="error">Ky ushqim eshte vleresuar tashme!</div>
<p>YPo e shihni kete faqe pasi ju tanime e keni vleresuar kete asortiment. <a href="member-index.php">Klikoni ketu</a> per tu kthyer te llogaria juaj dhe te vleresoni asortimente te tjera.</p>
</div>
</div>
<div id="footer">
