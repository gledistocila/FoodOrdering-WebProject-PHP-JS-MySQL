<?php
    ...
    if(isset($_POST['Update'])){
        ...
        $qry=mysql_query("SELECT * FROM timezones WHERE flag='$flag_1'") or die("Dicka nuk shkon ... \n" . mysql_error()); 
        if(mysql_num_rows($qry)>0){
            ...
            or die("Dicka nuk shkon ... \n". mysql_error());
                ...
                //Perform activation of another timezone
                 ...
                 if($result) {
                     // redirect back to the Opsionet page
                     header("Location: Opsionet.php");
                     exit();
                 }
                 else
                 // Gives an error
                 {
                    die("Aktivizimi i kohes deshtoi ..." . mysql_error());
                 }
        }
            else{
                    //Sanitize the POST values
