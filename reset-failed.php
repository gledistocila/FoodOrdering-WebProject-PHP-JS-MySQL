...
<title>Juvenilja:Rezervimi deshtoi</title>
...
<div id="center">
<h1>Resetimi i passwordit deshtoi</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<p>&nbsp;</p>
<div class="error">Resetimi i passwordit deshtoi!</div>
<p>Po e shihni kete faqe sepse tentativa juaj per te ndryshuar fjalekalimin ka deshtuar. Kjo ndodhi sepse eshte dhene informacion jo i sakte. Ju lutemi, korrigjoni informacionin dhe provojeni serish.</p>
</div>
</div>
<div id="footer">
