...
<title>Juvenilja:Vleresimi i suksesshem</title>
...
<div id="header">
  ...
  <div id="company_name">Restoranti Juvenilja</div>
</div>
<div id="center">
<h1>Vleresimi i suksesshem</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<p>&nbsp;</p>
<div class="error">Ushqimi i vleresimit u be me sukses!</div>
<p><a href="member-index.php">Klikoni ketu</a> per t'u kthyer ne llogarine tuaj.</p>
</div>
</div>
<div id="footer">
