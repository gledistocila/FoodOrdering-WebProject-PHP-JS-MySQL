...
<title>Juvenilja:Tavolinat</title>
...
<div id="center">
<h1>REZERVONI TAVOLINA</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<a href="member-index.php">Kryefaqja</a> | <a href="cart.php">Shporta[<?php echo $num_items;?>]</a> |  <a href="inbox.php">Inbox[<?php echo $num_messages;?>]</a> | <a href="tables.php">Tavolina</a> | <a href="partyhalls.php">Party-Hall</a> | <a href="ratings.php">Na vleresoni</a> | <a href="logout.php">Logout</a>
<p>&nbsp;</p>
...
<form name="tableForm" id="tableForm" method="post" action="reserve-exec.php?id=<?php echo $_SESSION['SESS_MEMBER_ID'];?>" onsubmit="return tableValidate(this)">
    <table align="center" width="300">
        <CAPTION><h2>REZERVONI NJE TAVOLINE</h2></CAPTION>
        <tr>
            <td><b>TEmri/Numri i tavolines:</b></td>
            <td><select name="table" id="table">
            <option value="select">- zgjidhni tavolinen -
            <?php 
