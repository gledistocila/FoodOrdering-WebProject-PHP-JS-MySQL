 ...
 //Function to sanitize values received from the form. Prevents SQL injection
	...
	$ConfirmNewPassword = clean($_POST['cpassword']);
     ...
     if (isset($_GET['id']))
     {
         ...
         or die("Ndryshimi i passwordit deshtoi! Please provoni perseri after a few minutes"); 
     ...
     {
        die("Ndryshimi i passwordit deshtoi! Ju lutemi provoni perseri apas disa minutash");
     } 
?>